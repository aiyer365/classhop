  ...
  return (
    <>
      <style jsx global>{`
        ...
        .redesign-main{flex:1;max-width:960px;width:100%;margin:0 auto;padding:0.5rem 2rem 6rem;overflow-x:hidden}.eyebrow{font-family:var(--font-mono);font-size:.68rem;letter-spacing:.18em;text-transform:uppercase;color:var(--gold-dim);margin-bottom:1.5rem}
